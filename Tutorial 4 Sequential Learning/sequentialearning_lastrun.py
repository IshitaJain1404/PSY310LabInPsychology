...
expName = 'sequentialearning'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='E:\\Ahmedabad University - BA (Hons.)\\Third Year\\Monsoon Semester\\PSY310 Lab in Psychology\\Experiments PsychoPy\\Tutorial 4\\sequentialearning_lastrun.py',
...
for thisTrial in trials:
    ...
    controlComponents = [fixation, line1, line2, line3, line4, probe, key_resp]
